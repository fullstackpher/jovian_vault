...
| [[CSS高级特性与新特性]] | CSS 变量、calc()、混合模式、clip-path | [[Less预处理器]]、 [[Sass预处理器]] |

### 8️⃣ CSS 工程化

| 笔记 | 简介 | 相关链接 |
|------|------|----------|
| [[CSS工程化]] | CSS 方法论、预处理器、后处理器、性能优化 | [[PostCSS]]、 [[Sass预处理器]]、 [[Less预处理器]] |
| [[PostCSS]] | CSS 处理工具链、Autoprefixer、CSS Modules | [[CSS工程化]] |
| [[Sass预处理器]] | Sass 语法、变量、嵌套、混合、继承 | - |
| [[Less预处理器]] | Less 语法、特性 | - |
...
| 笔记 | 简介 | 相关链接 |
|------|------|----------|
| [[This指向]] | this 指向规则（全局、构造函数、方法中） | [[面向对象]]、 [[函数]] |
| [[面向对象]] | 对象、构造函数、封装、继承、多态 | [[原型与原型链]]、 [[This指向]] |
| [[原型与原型链]] | 原型概念、原型链、原型对象、constructor | [[面向对象]]、 [[值类型和引用类型]] |
...
| 笔记 | 简介 | 相关链接 |
|------|------|----------|
| [[数学对象]] | Math 数学常量和数学方法 | [[运算符]] |
| [[数组]] | 数组的创建、操作方法、遍历、排序等 | [[值类型和引用类型]] |

### 6️⃣ BOM

| 笔记 | 简介 | 相关链接 |
|------|------|----------|
| [[Window对象]] | window 对象、全局变量与全局属性 | - |
...
6. **现代特性**：[[现代 CSS 新特性]] → [[CSS高级特性与新特性]]
7. **工程化**：[[CSS工程化]] → [[PostCSS]]/[[Sass预处理器]]/[[Less预处理器]]

### JavaScript 学习路径

1. **基础**：[[邂逅JavaScript]] → [[JavaScript基础]] → [[变量和数据类型]] → [[运算符]]
2. **核心**：[[函数]] → [[作用域]] → [[闭包]] → [[This指向]]
3. **面向对象**：[[面向对象]] → [[原型与原型链]]
4. **数据类型**：[[值类型和引用类型]] → [[包装类型]]
5. **内置对象**：[[数学对象]] → [[数组]] → [[变量和数据类型]]
6. **深入**：[[流程控制语句]]
...
| **JavaScript** | 函数、原型与原型链、闭包、this、数组操作 | [[函数]]、 [[原型与原型链]]、 [[闭包]]、 [[This指向]]、 [[数组]] |
